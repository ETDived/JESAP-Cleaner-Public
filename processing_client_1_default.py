...
def manipulate_data(company_code, input_path, fy):
    ...
    if (attempt == 0):
        ...
        with warnings.catch_warnings():
            ...
            if lc == 0 or lc == 1:
                try:
                    sum_df_fin['Amount in LC'] = sum_df_fin['Amount in LC'].str.replace('.', '')
            ...
            sum_df_fin['Amount'] = sum_df_fin['Amount'].str.replace('.', '')
        ...
        if (len(unmapped_tcode) != 0):
            ...
            if lc == 0 or lc == 1:
                ...
                sum_by_gl.to_csv(output_path + company_code + '_' + fy + '_sumGL_LC1.txt', index=False, sep='|')
